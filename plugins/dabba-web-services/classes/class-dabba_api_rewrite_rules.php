...
class DABBA_API_Rewrite_Rules {
	 ...
	 *
	 * @return null|DABBA_API_Rewrite_Rules
	 */
	...
	public function flush_rules() {
		...
		if ( ! isset( $rules[Dabba_Web_Service::WEBSERVICE_REWRITE] ) ) {
			global $wp_rewrite;
	...
	public function add_rewrite_rule( $rules ) {
		...
		$newrules                                            = array();
		$newrules[Dabba_Web_Service::WEBSERVICE_REWRITE] = 'index.php?webservice=1&service=$matches[1]';
