...
abstract class WC_Social_Login_Provider extends WC_Settings_API {
	...
	public function create_new_customer( $profile ) {
		...
		if ( is_wp_error( $customer_id ) ) {
			return new WP_Error( 'registration-error', '<strong>' . __( 'ERROR', WC_Social_Login::TEXT_DOMAIN ) . '</strong>: ' . __( 'Couldn&#8217;t register you&hellip; please contact us if you continue to have problems.', WC_Social_Login::TEXT_DOMAIN ) );
		}
