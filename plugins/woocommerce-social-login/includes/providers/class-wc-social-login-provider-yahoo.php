...
class WC_Social_Login_Provider_Yahoo extends WC_Social_Login_Provider {
	...
	public function __construct( $base_auth_path ) {
		...
		$this->notices = array(
			'account_linked'         => __( 'Your Yahoo account is now linked to your account.', WC_Social_Login::TEXT_DOMAIN ),
			'account_unlinked'       => __( 'Yahoo account was successfully unlinked from your account.', WC_Social_Login::TEXT_DOMAIN ),
			'account_already_linked' => __( 'This Yahoo account is already linked to another user account.', WC_Social_Login::TEXT_DOMAIN ),
			'account_already_exists' => __( 'A user account using the same email address as this Yahoo account already exists.', WC_Social_Login::TEXT_DOMAIN ),
		);
	...
	public function get_description() {
		...
		return sprintf( __( 'Need help setting up and configuring Yahoo? %sRead the docs%s', WC_Social_Login::TEXT_DOMAIN ), '<a href="http://docs.woothemes.com/document/woocommerce-social-login-create-social-apps#yahoo">', '</a>' );
	}
	...
	public function init_form_fields() {
		...
		$this->form_fields['secret']['title'] = __( 'Client Secret', WC_Social_Login::TEXT_DOMAIN );
	}
	...
	public function get_default_login_button_text() {
		...
		return __( 'Log in with Yahoo', WC_Social_Login::TEXT_DOMAIN );
	}
	...
	public function get_default_link_button_text() {
		...
		return __( 'Link your account to Yahoo', WC_Social_Login::TEXT_DOMAIN );
	}
