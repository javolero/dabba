...
class WC_Social_Login_Frontend {
	...
	public function render_social_login_buttons() {
		...
		$return_url = is_checkout() ? WC()->cart->get_checkout_url() : SV_WC_Plugin_Compatibility::wc_get_page_permalink( 'myaccount' );
	...
	public function load_styles_scripts() {
		...
		// frontend scripts
		wp_enqueue_script( 'wc-social-login-frontend', wc_social_login()->get_plugin_url() . '/assets/js/frontend/wc-social-login.min.js', array( 'jquery' ), WC_Social_Login::VERSION );
