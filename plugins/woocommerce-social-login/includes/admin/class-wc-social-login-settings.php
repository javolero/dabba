...
class WC_Settings_Social_Login extends WC_Settings_Page {
	...
	public function get_settings() {
		...
		return apply_filters('woocommerce_social_login_settings', array(
			...
			array(
				'name'     => __( 'Force SSL for all providers', WC_Social_Login::TEXT_DOMAIN ),
				'desc'     => __( 'Enable to force SSL (HTTPS) on callback URLs for all providers (an SSL Certificate is required).', WC_Social_Login::TEXT_DOMAIN ),
