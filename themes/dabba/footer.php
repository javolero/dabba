			...
			<div class="[ modal-content ][ text-center ]">
				...
				<div class="[ modal-body ][ bg-primary ][ padding--top--xxlarge padding--bottom--large ]">
					<div class="[ margin-bottom--large ]">
						...
						<form>
							<input class="[ form-control form-control-bg ][ col-xs-12 ][ margin-bottom--small ]" name="email-comienza" placeholder="Correo electrónico">
					...
					<div class="[ container ]">
						<form method="post" class="[ register ][ row ]">
							...
							<?php if ( 'no' === get_option( 'woocommerce_registration_generate_password' ) ) : ?>
								...
								<input class="[ form-control form-control-bg ][ margin-bottom--small ][ input-text ][ col-xs-12 ]" name="password" type="password" id="reg_password">
